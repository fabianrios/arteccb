...
$(document).ready(function() {
		...
		$("#add-expo-3").click(function(evt){
			//evt.preventDefault();
		$(".link_list-3").hide().append('<li class="link_default"><ul class="resume-more no-bullet"><li class="handler"><img src="<?php echo APPLICATION_URL;?>images/drag_handle.gif" alt="drag_handle" width="11" height="11" class="image_handle nsr"></li><li><input name="prize_name_'+counterPrize+'" class="expand input-text" type="text" /></li><li><input name="prize_institution_'+counterPrize+'" class="expand input-text" type="text" /></li><li><input name="prize_city_'+counterPrize+'" class="expand input-text" type="text" /></li><li class="country"><select name="prize_country_id_'+counterPrize+'" id=""><?php foreach ($countries as $country){?><option value="<?php echo $country->__get('country_id');?>"><?php echo utf8_encode($country->__get('country_name'));?></option><?php }?></select></li> <li class="date"><select name="prize_year_'+counterPrize+'"><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option> <option value="2008">2008</option></select></li><li class="handler"><a href="#" class="delete-expo"><img src="<?php echo APPLICATION_URL?>images/trash.gif" alt="caneca" title="caneca" width="37" height="37" /></a></li></ul></li>').fadeIn(1000);

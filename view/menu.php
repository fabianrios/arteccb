...
<div class="row">
	<div class="twelve columns ">
		<div class="right">
			El registro de <span class="redtxt">Pabellón Artecámara</span> vence en <span class="red label radius"><?php echo $days;?></span> <strong>días,</strong> <span>el 30 de Abril</span>
		</div>
	</div>
</div>
<!--END  vencimiento -->

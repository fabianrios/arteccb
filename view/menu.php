...
<div class="row">
	<div class="twelve columns ">
		<div class="right">
			El registro de <span class="redtxt">Pabellón Artecámara</span> vence en <span class="red label radius"><?php echo $days;?></span> <strong>días</strong> <span>(30 de abril 2013)</span>
		</div>
	</div>
</div>
<!--END  vencimiento -->

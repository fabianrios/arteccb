						...
						<table border="0" cellspacing="0" cellpadding="0">
							<thead>
								<tr>
									<th></th>
                                	<?php
									$var 	= 'TRIM(user_name), TRIM(user_surname)';
									$icon	=	'▼';
									if ($order	== 'TRIM(user_name), TRIM(user_surname)')
									{
										$var	= 'TRIM(user_name) DESC, TRIM(user_surname) DESC';
										$icon	= '▲';
									}										
									?> 									
									<th>Nombre del artista <a href="<?php echo APPLICATION_URL?>indice-artistas.panel/<?php echo $size?>/<?php echo $var?>.html"><?php echo $icon ?></a> </th>
									<th>Contacto</th>
									<th>Documento</th>
                                	<?php
									$var 	= 'user_city';
